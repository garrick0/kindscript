...
describe('ClassifyASTService - satisfies InstanceConfig<T> and Multi-file', () => {
  ...
  describe('Multi-file classification', () => {
    it('processes multiple definition files', () => {
      ...
      const result = service.execute({
        definitionFiles: [sourceFile('/project/src/kinds.ts'), sourceFile('/project/src/instances.ts')],
        checker: mockChecker,
        projectRoot: '/project',
      });
    ...
    it('handles empty definition files', () => {
      const result = service.execute({
        definitionFiles: [sourceFile('/project/src/empty.ts')],
        checker: mockChecker,
        projectRoot: '/project',
      });
  ...
  describe('satisfies InstanceConfig<T> recognition', () => {
    ...
    it('infers root from source file directory', () => {
      ...
      const result = service.execute({
        definitionFiles: [sourceFile('/my-app/modules/ordering/ordering.ts')],
        checker: mockChecker,
        projectRoot: '/my-app',
      });
