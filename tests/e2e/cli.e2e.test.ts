...
describe('CLI E2E', () => {
  ...
  describe('ksc scaffold', () => {
    it('on clean-arch fixture exits 0 with plan output', () => {
    ...
    it('with no kindscript.json exits 1', () => {
    ...
    it('with no definitions in config exits 1', () => {
    ...
    describe('--instance flag', () => {
      it('scaffolds specific instance on multi-instance fixture', () => {
      ...
      it('on multi-instance fixture without --instance exits 1', () => {
        const fixturePath = path.join(FIXTURES_DIR, 'scaffold-multi-instance');
        const result = run(['scaffold', fixturePath]);
    ...
    describe('round-trip workflow', () => {
      it('infer --write then scaffold --write then check', () => {
        ...
        try {
          ...
          const inferResult = run(['infer', '--write', tmpDir]);
          ...
          const scaffoldResult = run(['scaffold', '--write', tmpDir]);
          ...
          const checkResult = run(['check', tmpDir]);
