...
describe('Contract', () => {
  ...
  describe('validation', () => {
    ...
    it('validates mustImplement contract with correct args', () => {
      const ports = new ArchSymbol('ports', ArchSymbolKind.Member);
      const adapters = new ArchSymbol('adapters', ArchSymbolKind.Member);
    ...
    it('rejects mustImplement contract with wrong arg count', () => {
      const symbol = new ArchSymbol('ports', ArchSymbolKind.Member);
    ...
    it('rejects purity contract with wrong arg count', () => {
      const domain = new ArchSymbol('domain', ArchSymbolKind.Member);
      const other = new ArchSymbol('other', ArchSymbolKind.Member);
    ...
    it('validates noCycles contract with multiple args', () => {
      ...
      const s3 = new ArchSymbol('s3', ArchSymbolKind.Member);
