import { GetPluginCodeFixesService } from '../../src/application/use-cases/get-plugin-code-fixes/get-plugin-code-fixes.service';

describe('GetPluginCodeFixesService', () => {
  let service: GetPluginCodeFixesService;

  beforeEach(() => {
    service = new GetPluginCodeFixesService();
  });
