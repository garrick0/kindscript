    ...
    describe('forbiddenDependency', () => {
      it('creates diagnostic for forbidden dependency', () => {
        ...
        const contract = new Contract(
          ...
          'no-infra-deps',
          [
            new ArchSymbol('domain', ArchSymbolKind.Member),
            new ArchSymbol('infrastructure', ArchSymbolKind.Member),
          ],
          'architecture.ts:10'
        );
    ...
    describe('missingImplementation', () => {
      it('creates diagnostic for missing implementation', () => {
        const contract = new Contract(
          ...
          'ports-have-adapters',
          [
            new ArchSymbol('ports', ArchSymbolKind.Member),
            new ArchSymbol('adapters', ArchSymbolKind.Member),
          ],
          'architecture.ts:20'
        );
    ...
    describe('circularDependency', () => {
      it('creates diagnostic for circular dependency', () => {
        const contract = new Contract(
          ...
          'no-cycles',
          [new ArchSymbol('module', ArchSymbolKind.Member)],
          'architecture.ts:40'
        );
      ...
      it('creates diagnostic for mirror mismatch', () => {
        const contract = new Contract(
          ...
          [
            ...
            new ArchSymbol('test', ArchSymbolKind.Member),
          ]
        );
