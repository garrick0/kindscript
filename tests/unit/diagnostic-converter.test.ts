import { convertToTSDiagnostic, convertToCodeFixAction } from '../../src/infrastructure/plugin/diagnostic-converter';
...
describe('convertToCodeFixAction', () => {
  it('creates a CodeFixAction with correct fields', () => {
    ...
    const result = convertToCodeFixAction(fix, '/project/src/index.ts', 0, 50, mockTypescript);
