...
describe('Architecture Validation: Value Objects', () => {
  ...
  describe('DependencyRule', () => {
    it('models allowed dependencies', () => {
      const from = new ArchSymbol('infrastructure', ArchSymbolKind.Member, 'src/infrastructure');
      const to = new ArchSymbol('domain', ArchSymbolKind.Member, 'src/domain');
    ...
    it('models forbidden dependencies', () => {
      const from = new ArchSymbol('domain', ArchSymbolKind.Member, 'src/domain');
      const to = new ArchSymbol('infrastructure', ArchSymbolKind.Member, 'src/infrastructure');
    ...
    it('checks if specific import violates rule', () => {
      const domain = new ArchSymbol('domain', ArchSymbolKind.Member, 'src/domain');
      const infra = new ArchSymbol('infrastructure', ArchSymbolKind.Member, 'src/infrastructure');
  ...
  describe('Integration: modeling dependency graph', () => {
    it('models complete dependency scenario', () => {
      ...
      const domain = new ArchSymbol('domain', ArchSymbolKind.Member, 'src/domain');
      const application = new ArchSymbol('application', ArchSymbolKind.Member, 'src/application');
      const infrastructure = new ArchSymbol('infrastructure', ArchSymbolKind.Member, 'src/infrastructure');
